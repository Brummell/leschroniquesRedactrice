...
<div class="table-responsive">
    <div class="table-wrapper">
        <div class="table-title">
            <div class="row">
                <div class="col-sm-6">
                    <h2>Page <b>d'accueil</b></h2>
                </div>
                <div class="col-sm-6">
                    <a href="{{route('admin.home.create')}}" class="btn btn-success"><i class="material-icons">&#xE147;</i> <span>Ajouter une ligne</span></a>
                </div>
            </div>
        </div>
            ...
            <tbody class="">					
                @foreach ($home as $item)
                    <tr class="card-sel">
                        ...
                        <td>{{$item->linkidin}}</td>
                        <td><img src="data:image/jpeg;base64,{{$item->logo}}" width=25 height=25/></td>
                        <td class="d-flex">
                            <a href="{{route('admin.home.edit',['home'=>$item->id_home])}}" class="edit"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                            <form action="{{route('admin.home.destroy',['home'=>$item->id_home])}}" method="post">
                                @method('delete')
                                @csrf
