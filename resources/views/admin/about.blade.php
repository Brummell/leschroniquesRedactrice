    ...
    <div class="table-wrapper">
        <div class="table-title">
            <div class="row">
                ...
                <div class="col-sm-6">
                    <a href="{{route('admin.about.create')}}" class="btn btn-success"><i class="material-icons">&#xE147;</i> <span>Ajouter une ligne</span></a>
                </div>
            </div>
        </div>
            ...
            <tbody class="">					
                @foreach ($about as $item)
                    <tr class="card-sel">
                        ...
                        <td>{{$item->apropos}}</td>
                        <td class="d-flex">
                            <a href="{{route('admin.about.edit',['about'=>$item->id_about])}}" class="edit"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                            <form action="{{route('admin.about.destroy',['about'=>$item->id_about])}}" method="post">
                                @method('delete')
                                @csrf
