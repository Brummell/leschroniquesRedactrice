...
<div class="table-responsive">
    <div class="table-wrapper">
        <div class="table-title">
            <div class="row">
                <div class="col-sm-6">
                    <h2>Page <b>article</b></h2>
                </div>
                <div class="col-sm-6">
                    <a href="{{route('admin.post.create')}}" class="btn btn-success"><i class="material-icons">&#xE147;</i> <span>Ajouter une ligne</span></a>
                </div>
            </div>
        </div>
            ...
            <tbody class="">					
                @foreach ($post as $item)
                    <tr class="card-sel">
                        ...
                        <td>{{$item->text_2}}</td>
                        <td class="d-flex">
                            <a href="{{route('admin.post.edit',['post'=>$item->id_post])}}" class="edit"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                            <form action="{{route('admin.post.destroy',['post'=>$item->id_post])}}" method="post">
                                @method('delete')
                                @csrf
